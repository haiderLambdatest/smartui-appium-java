...
Clone the LambdaTest’s :link: [smartui-appium-java](https://github.com/LambdaTest/smartui-appium-java) repository and navigate to the code directory as shown below:

```bash
git clone https://github.com/LambdaTest/smartui-appium-java
cd smartui-appium-java
```
...
**Test Scenario:** Check out [SmartuiAndroid.java](https://github.com/LambdaTest/smartui-appium-java/blob/master/src/test/java/SmartuiAndroid.java) file to view the sample test script for android and [SmartuiIOS.java](https://github.com/LambdaTest/smartui-appium-java/blob/master/src/test/java/SmartuiIOS.java) for iOS.
...
- You can generate capabilities for your test requirements with the help of our inbuilt **[Capabilities Generator tool](https://www.lambdatest.com/capabilities-generator/beta/index.html?utm_source=github&utm_medium=repo&utm_campaign=smartui-appium-java)**. A more Detailed Capability Guide is available [here](https://www.lambdatest.com/support/docs/desired-capabilities-in-appium/?utm_source=github&utm_medium=repo&utm_campaign=smartui-appium-java).
